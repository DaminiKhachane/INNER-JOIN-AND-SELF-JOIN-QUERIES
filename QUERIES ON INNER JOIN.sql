...
/*1)WAQTD ename , sal and dname of the employee working as 
Clerk in dept 20 with a salary of more than 1800 .*/
SELECT ENAME,SAL,DNAME
FROM EMP INNER JOIN DEPT
ON EMP.DEPTNO=DEPT.DEPTNO
WHERE JOB='CLERK' AND EMP.DEPTNO=20
AND SAL>1800;

/*2)WAQTD ename deptno , dname and loc of the employee 
...
/*5)WAQTD DNAME AND ANNUAL SALARY FOR ALL  EMPLOYEES 
...
/*6)WAQTD ENAME AND DNAME FOR EMPLOYEES HAVING 
...
/*7)WAQTD ENAME AND DNAME FOR ALL THE EMPLOYEES 
WORKING AS SALESMAN */
SELECT ENAME,DNAME
FROM EMP INNER JOIN DEPT
ON EMP.DEPTNO=DEPT.DEPTNO
...
FROM EMP INNER JOIN DEPT
ON EMP.DEPTNO=DEPT.DEPTNO
WHERE COMM IS NOT NULL AND EMP.DEPTNO IN (20,30);

/*12)WAQTD DNAME AND EMPNO FOR ALL THE EMPLOYEES WHO'S   
