...
/*2.WAQTD NAME OF THE EMPLOYEE AND MANAGER'S 
...
EMPLOYEE WAS HIRED BEFORE 1982 */
...
SELECT E1.ENAME,E1.SAL,E2.ENAME AS MANAGER_NAME,E2.SAL
FROM EMP E1 JOIN EMP E2
ON E1.MGR = E2.EMPNO
WHERE E1.SAL> E2.SAL;
